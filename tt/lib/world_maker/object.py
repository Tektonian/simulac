...
from tt.sdk import environment_management_service, environment_build_service, runner_management_service
...
class Environment:
    ...
    def place_stuff_entity(
        ...
        stuff_object = StuffObject(entity_id, __prevent_user_direct_call = False)
    ...
    def place_robot_entity(
        ...
        robot_object = RobotObject(entity_id, __prevent_user_direct_call = False)
